...
int main(int argc,char**argv){
  ...
  if(argc<2){
    printf("testonerecord must be called with 2 arguments:\n");
    printf("recordname,  signal channel to use\n");
    exit(-1);
  }
  ...
  while(NextSample(ecg, nsig,InputFileSampleFrequency,SAMPLE_RATE,0) >= 0){
    ...
    // changed !!!!!!!!!!!!!!!!!!!!!
    delay = BeatDetectAndClassify(ecg[channel], &beatType, &beatMatch) ;

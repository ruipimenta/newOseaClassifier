...
#define MS_PER_SAMPLE 5
              //	( (double) 1000/ (double) SAMPLE_RATE)
#define MS10 2	
              //((int) (10/ MS_PER_SAMPLE + 0.5))
#define MS25 5
              //	((int) (25/MS_PER_SAMPLE + 0.5))
#define MS30 6
              //	((int) (30/MS_PER_SAMPLE + 0.5))
#define MS80 16
              //	((int) (80/MS_PER_SAMPLE + 0.5))
#define MS95 19
              //	((int) (95/MS_PER_SAMPLE + 0.5))
#define MS100 20
              //	((int) (100/MS_PER_SAMPLE + 0.5))
#define MS125 25
...
#define	FILTER_DELAY  1+MS25-1+12+ PRE_BLANK
              //(int) (((double) DERIV_LENGTH/2) + ((double) LPBUFFER_LGTH/2 - 1) + (((double) HPBUFFER_LGTH-1)/2) + PRE_BLANK)  
